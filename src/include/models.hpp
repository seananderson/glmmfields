...
nngp_w_lpdf(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& w,
    ...
    try {
        ...
        Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,1>  I_Aw(static_cast<Eigen::VectorXd::Index>(N));
        (void) I_Aw;  // dummy to suppress unused var warning

        stan::math::initialize(I_Aw, std::numeric_limits<double>::quiet_NaN());
        ...
        for (int i = 2; i <= N; ++i) {
            ...
            validate_non_negative_index("iNNdistM", "(logical_lt(i,(M + 1)) ? (i - 1) : M )", (logical_lt(i,(M + 1)) ? (i - 1) : M ));
            Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  iNNdistM(static_cast<Eigen::VectorXd::Index>((logical_lt(i,(M + 1)) ? (i - 1) : M )),static_cast<Eigen::VectorXd::Index>((logical_lt(i,(M + 1)) ? (i - 1) : M )));
            (void) iNNdistM;  // dummy to suppress unused var warning

            stan::math::initialize(iNNdistM, std::numeric_limits<double>::quiet_NaN());
            stan::math::fill(iNNdistM,DUMMY_VAR__);
            validate_non_negative_index("iNNCholL", "(logical_lt(i,(M + 1)) ? (i - 1) : M )", (logical_lt(i,(M + 1)) ? (i - 1) : M ));
            validate_non_negative_index("iNNCholL", "(logical_lt(i,(M + 1)) ? (i - 1) : M )", (logical_lt(i,(M + 1)) ? (i - 1) : M ));
            Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  iNNCholL(static_cast<Eigen::VectorXd::Index>((logical_lt(i,(M + 1)) ? (i - 1) : M )),static_cast<Eigen::VectorXd::Index>((logical_lt(i,(M + 1)) ? (i - 1) : M )));
            (void) iNNCholL;  // dummy to suppress unused var warning

            stan::math::initialize(iNNCholL, std::numeric_limits<double>::quiet_NaN());
            stan::math::fill(iNNCholL,DUMMY_VAR__);
            validate_non_negative_index("iNNcorr", "(logical_lt(i,(M + 1)) ? (i - 1) : M )", (logical_lt(i,(M + 1)) ? (i - 1) : M ));
            Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,1>  iNNcorr(static_cast<Eigen::VectorXd::Index>((logical_lt(i,(M + 1)) ? (i - 1) : M )));
            (void) iNNcorr;  // dummy to suppress unused var warning

            stan::math::initialize(iNNcorr, std::numeric_limits<double>::quiet_NaN());
            stan::math::fill(iNNcorr,DUMMY_VAR__);
            validate_non_negative_index("v", "(logical_lt(i,(M + 1)) ? (i - 1) : M )", (logical_lt(i,(M + 1)) ? (i - 1) : M ));
            Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,1>  v(static_cast<Eigen::VectorXd::Index>((logical_lt(i,(M + 1)) ? (i - 1) : M )));
            (void) v;  // dummy to suppress unused var warning

            stan::math::initialize(v, std::numeric_limits<double>::quiet_NaN());
            stan::math::fill(v,DUMMY_VAR__);
            validate_non_negative_index("v2", "(logical_lt(i,(M + 1)) ? (i - 1) : M )", (logical_lt(i,(M + 1)) ? (i - 1) : M ));
            Eigen::Matrix<fun_scalar_t__,1,Eigen::Dynamic>  v2(static_cast<Eigen::VectorXd::Index>((logical_lt(i,(M + 1)) ? (i - 1) : M )));
            ...
            if (as_bool(logical_eq(dim,1))) {
                ...
                stan::math::assign(get_base1_lhs(iNNdistM,1,1,"iNNdistM",1), 1);
            } else {
                ...
                for (int j = 1; j <= dim; ++j) {
                    ...
                    stan::math::assign(get_base1_lhs(iNNdistM,j,j,"iNNdistM",1), 1);
                }
            }
            ...
            stan::math::assign(get_base1_lhs(I_Aw,i,"I_Aw",1), (get_base1(I_Aw,i,"I_Aw",1) - multiply(v2,stan::model::rvalue(w, stan::model::cons_list(stan::model::index_multi(stan::model::rvalue(NN_ind, stan::model::cons_list(stan::model::index_uni((i - 1)), stan::model::cons_list(stan::model::index_min_max(1, dim), stan::model::nil_index_list())), "NN_ind")), stan::model::nil_index_list()), "w"))));
            }
        }
        stan::math::assign(get_base1_lhs(V,1,"V",1), 1);
        return stan::math::promote_scalar<fun_return_scalar_t__>((-(0.5) * ((((1 / sigmasq) * dot_product(I_Aw,elt_divide(I_Aw,V))) + sum(log(V))) + (N * log(sigmasq)))));
        }
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        // Next line prevents compiler griping about no return
