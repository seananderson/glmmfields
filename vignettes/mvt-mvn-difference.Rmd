...
Let's plot of the true data, and the spatial productions from the correct and incorrect models.
...
The following plot looks at the differences in the predictions of spatially 
