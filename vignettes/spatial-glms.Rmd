...
Now we'll add two arguments to the glmmfields() call. First, we'll set method = "NNGP", and second we'll specify the number of neighbors used in calculations (nngp_neighbors, defaults to 5).  

```{r}
m_spatial <- glmmfields(y ~ temperature,
  data = d, family = Gamma(link = "log"),
  lat = "lat", lon = "lon", nknots = 12, iter = 1000, chains = 1,
  prior_intercept = student_t(3, 0, 10), 
  prior_beta = student_t(3, 0, 3),
  prior_sigma = half_t(3, 0, 3),
  prior_gp_theta = half_t(3, 0, 10),
