...
Let's simulate some data to fit our model to. We will use the built-in function `sim_glmmfields()`, but normally you would start with your own data. We will simulate 100 data points, some temperature data, an underlying random field spatial pattern, and add some observation error. 
...
s <- sim_glmmfields(n_draws = 1, gp_theta = 2, n_data_points = N,
