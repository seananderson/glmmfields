...
Now we'll add two arguments to the glmmfields() call. First, we'll set method = "NNGP", and second we'll specify the number of neighbors used in calculations (nngp_neighbors, defaults to 5). Increasing the number of neighbors tends to make calculations more slow, and the estimated surface more smooth.
